...
You must also set the `GLPI_MARKETPLACE_URL` environment variable to `/var/www/glpi/marketplace` or if you are building the image you can set the build arg `GLPI_MARKETPLACE_DIR`.
